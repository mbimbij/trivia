...
class QuestionsLoaderTest {
    ...
    void can_load_properties_from_file() {
        QuestionsLoader initializationStrategy = new QuestionsLoader();
        Map<Questions.Category, Queue<String>> questions = initializationStrategy.loadQuestionsFromDirectory("src/test/resources/questions-test");
